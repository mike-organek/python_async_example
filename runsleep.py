...
# Please note that the result from each of the tasks is returned back by the 
# call to asyncio.gather().  It seems unremarkable but is much simpler than
# passing results back on queues in multiprocessing or multithreading.
def run_the_async():
